...
export const className = {
    ...
    button: "text-xs md:text-sm lg:text-base border-2 border-slate-200 whitespace-nowrap rounded-3xl px-5 py-1 ml-2 duration-100 hover:border-blue-400 hover:text-blue-400",
    buttonPrimary: "text-xs md:text-sm lg:text-base border-2 border-green-600 text-green-600 whitespace-nowrap rounded-3xl px-5 py-1 ml-2 duration-100 hover:border-green-900 hover:text-green-900",
    ...
    link: "cursor-pointer block text-blue-800 hover:underline py-1 px-2 rounded-lg"
};
